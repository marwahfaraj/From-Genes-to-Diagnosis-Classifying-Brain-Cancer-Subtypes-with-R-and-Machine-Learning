...
# ------------------------------------------------------------
cat("Running weighted NB on PCA data...\n")
...
# SMOTE Naive Bayes
# ------------------------------------------------------------
cat("Running SMOTE NB on PCA data...\n")
...
# Save the summary
write.csv(summary_df, "output/model/metrics/summary_nb_pca.csv", row.names = FALSE)

cat("Saved Naive Bayes performance metrics with PCA using Weighted + SMOTE.\n")
